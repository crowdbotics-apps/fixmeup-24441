"""fixmeup_24441 URL Configuration
...
admin.site.site_header = "FixMeUp"
admin.site.site_title = "FixMeUp Admin Portal"
admin.site.index_title = "FixMeUp Admin"

# swagger
api_info = openapi.Info(
    title="FixMeUp API",
    default_version="v1",
    description="API documentation for FixMeUp App",
)
